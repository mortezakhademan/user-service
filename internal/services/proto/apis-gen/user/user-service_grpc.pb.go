...
const (
	UserService_InsertUser_FullMethodName  = "/github.com.mortezakhademan.UserService/InsertUser"
	UserService_UpdateUser_FullMethodName  = "/github.com.mortezakhademan.UserService/UpdateUser"
	UserService_GetUser_FullMethodName     = "/github.com.mortezakhademan.UserService/GetUser"
	UserService_GetUserList_FullMethodName = "/github.com.mortezakhademan.UserService/GetUserList"
	UserService_DeleteUser_FullMethodName  = "/github.com.mortezakhademan.UserService/DeleteUser"
)
...
type UserServiceClient interface {
	InsertUser(ctx context.Context, in *InsertUserRequest, opts ...grpc.CallOption) (*Id, error)
	UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetUser(ctx context.Context, in *Id, opts ...grpc.CallOption) (*User, error)
	GetUserList(ctx context.Context, in *list.PaginatedListRequest, opts ...grpc.CallOption) (*UserListResponse, error)
...
func (c *userServiceClient) InsertUser(ctx context.Context, in *InsertUserRequest, opts ...grpc.CallOption) (*Id, error) {
...
func (c *userServiceClient) GetUserList(ctx context.Context, in *list.PaginatedListRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	InsertUser(context.Context, *InsertUserRequest) (*Id, error)
	UpdateUser(context.Context, *UpdateUserRequest) (*emptypb.Empty, error)
	GetUser(context.Context, *Id) (*User, error)
	GetUserList(context.Context, *list.PaginatedListRequest) (*UserListResponse, error)
...
func (UnimplementedUserServiceServer) InsertUser(context.Context, *InsertUserRequest) (*Id, error) {
...
func (UnimplementedUserServiceServer) GetUserList(context.Context, *list.PaginatedListRequest) (*UserListResponse, error) {
...
func _UserService_GetUserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserList(ctx, req.(*list.PaginatedListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.mortezakhademan.UserService",
